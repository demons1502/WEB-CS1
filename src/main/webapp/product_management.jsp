            ...
            <div class="col-sm-9 table-admin">
                <table class="table table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <th scope="col">Sản phẩm đặc biệt</th>
                        <th scope="col">Thao tác</th>
                    </tr>
                    </thead>
                    <tbody>
                        <c:forEach items="${list}" var="o">
                            <c:set var="cate_id" value="${o.category_id}"></c:set>
                            <tr>
                                <td>${o.productID}</td>
                                ...
                                <c:forEach items="${listcate}" var="c">
                                    <c:if test="${cate_id == c.category_id}" >
                                        <td>${c.name}</td>
                                    </c:if>
                                </c:forEach>
                                <td width="20px">${o.featured}</td>
                                <td width="100px">
                                    <a href="UpdatePr?idedit=${o.productID}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                    </svg></a>
                                    <a href="Delete?delid=${o.productID}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                        <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                                        </svg></a>
                                    <a href="LoadImage?idupdate=${o.productID}">
            ...
            <div class="modal-body">
                <form action="AddProduct" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pricepro" class="form-control" id="Price"></input>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" id="Category" name="selectpro">
                    ...
                    <div class="form-group">
                        <label for="featured" class="col-form-label">Sản phẩm đặc biệt:</label>
                        <select class="custom-select" id="Featured" name="feapro">
                            <option value="1">Sản phẩm đặc biệt</option>
                            <option value="0">Sản phẩm thường</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="description" class="col-form-label">Mô tả:</label>:</label>
                        <textarea type="text" name="descrip" class="form-control" id="Description"></textarea>
                    </div>
